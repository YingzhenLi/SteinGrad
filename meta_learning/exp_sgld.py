...
acc_op, ll_op = evaluate(X_ph_test, y_ph, theta_ph_test, shapes, activation = activation_test)
grad_test = grad_logp_func(X_ph_test, y_ph, theta_ph_test, N_ph, shapes, activation = activation_test)
